...
EndMe:
        ...
        Public Sub InitForm(ByRef dm_DSN As ADODB.Connection, ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            ...
            If HasGrid Then
                'AddHandler dm_Grid.OnAddNew, AddressOf dm_Grid_OnAddNew // maa
                'AddHandler dm_Grid.AfterColEdit, AddressOf dm_Grid_AfterColEdit  // maa
        ...
        Public Sub PopulateForm(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Dim Num As Byte
            Dim Num2 As Integer
        ...
        Public Sub GoFirst(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
        ...
        Public Sub GoLast(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Me.ClearData(dm_Form, dm_DetailTable)
            If Not dm_MasterTable.EOF Then
        ...
        Public Sub GoNext(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Me.ClearData(dm_Form, dm_DetailTable)
            If Not dm_MasterTable.EOF Then
        ...
        Public Sub GoPrevious(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Me.ClearData(dm_Form, dm_DetailTable)
        ...
        Public Sub NewRecord(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
        ...
        Public Sub DeleteRecord(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
        ...
        Private Sub SubSaveData(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Dim Num As Byte
            Dim CtrlName As String
        ...
        Public Sub SaveData(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Dim cFilter As String = ""
            Dim Num As Byte
...
ReleaseSaving:
        ...
        Public Sub KeyLeave(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
            Dim Num As Byte
            Dim cFilter As String = ""
        ...
        Public Function GetValue(ByVal str_Table As String, ByVal str_Key As String, ByVal str_value As String, ByVal str_RetField As String) As String
            ...
            oRecSet.Open(str_Table, CN, ADODB.CursorTypeEnum.adOpenKeyset, ADODB.LockTypeEnum.adLockOptimistic)
            If str_value <> "" Then
                oRecSet.MoveFirst()
        ...
        Public Sub AddGridRelatedValue(ByVal str_Table As String, ByVal str_TableKey As String, ByVal str_Column As String, ByVal str_TableRetField As String, ByVal str_GridRetColumn As String, Optional ByVal n_ZeroPad As Byte = 0)
            ...
            For Num = 0 To MyGrid.Columns.Count - 1
                'If UCase(MyGrid.Columns(Num).DataField) = UCase(str_Column) Then // maa to the following 4
        ...
        Private Sub PopulateGrid(ByRef dm_Grid As DataGridView, ByRef dm_MasterTable As ADODB.Recordset, ByRef dm_DetailTable As ADODB.Recordset)
            Dim cFilter As String = ""
            Dim Num As Byte
            Dim X As Byte
            Dim X_ As Byte
            ...
            For X = 1 To Col_GridKeyValue.Count / 6
                X_ = (X - 1) * 6 + 1
                oRecSet.Open(Col_GridKeyValue(X_), CN, ADODB.CursorTypeEnum.adOpenKeyset, ADODB.LockTypeEnum.adLockOptimistic)
                dm_DetailTable.MoveFirst()
                Do While Not dm_DetailTable.EOF
                    oRecSet.MoveFirst()
            ...
            If FlipState = True Then
                ...
                Next
            End If
            'dm_Grid.AllowAddNew = True  // maa
            'dm_Grid.AllowDelete = True  // maa
        End Sub
        ...
        Public Sub Search(ByRef dm_Form As System.Windows.Forms.Form, ByRef dm_MasterTable As ADODB.Recordset, Optional ByRef dm_Grid As DataGridView = Nothing, Optional ByRef dm_DetailTable As ADODB.Recordset = Nothing)
